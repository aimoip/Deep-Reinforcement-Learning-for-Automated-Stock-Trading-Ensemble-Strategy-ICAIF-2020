...
class StockEnvValidation(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            ...
            print("at the step and trying to write account_value_validation in iteration #",self.iteration)
            ...
            self.day += 1
            self.data = self.df.loc[self.day,:]         
            print("all self.data['turbulence']",self.data['turbulence'])
            ...
            self.state =  [self.state[0]] + \
                    ...
                    list(self.state[(STOCK_DIM+1):(STOCK_DIM*2+1)]) + \
                      ...
                      [self.data.cci] + \
                      [self.data.adx]
            print("self state in val env is ",self.state)
